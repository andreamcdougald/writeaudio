        ...
        <div className="relative">
          <blockquote className="mt-10">
            ...
            <div className="mx-auto max-w-3xl text-center text-xl font-medium leading-9 text-gray-900">
              <p>
                &ldquo; As a self-published author I didn't think creating an
                audiobook was something I could do myself - until now! &rdquo;
              </p>
            </div>
            <footer className="mt-8">
              <div className="md:flex md:items-center md:justify-center">
                ...
                <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                  ...
                  <svg
                    className="mx-1 hidden h-5 w-5 text-cream md:block"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
